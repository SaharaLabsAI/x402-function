...
## Overview
The x402 Spring Boot Starter provides seamless integration of the x402 Server SDK and vendor SPI into Spring Boot applications. It enables automatic payment interception and settlement for web endpoints, supporting blockchain-based payments (e.g., USDC on Base Sepolia).
